...
@router.get("/slots", response_model=InterviewSlotListResponse)
...
@router.get("/slots/{slot_id}", response_model=InterviewSlotResponse)
...
@router.put("/slots/{slot_id}", response_model=InterviewSlotResponse)
...
@router.get("/calendar/available", response_model=List[InterviewSlotResponse])
...
@router.get("/stats/overview", response_model=InterviewStatsResponse)
