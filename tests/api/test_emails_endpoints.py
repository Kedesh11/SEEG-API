...
class TestEmailsEndpoints:
    ...
    @patch('app.api.v1.endpoints.emails.get_current_user')
    @patch('app.api.v1.endpoints.emails.EmailService')
    @patch('app.api.v1.endpoints.emails.get_async_db')
    def test_send_email_success(self, mock_get_db, mock_email_service, mock_get_user):
    ...
    @patch('app.api.v1.endpoints.emails.EmailService')
    @patch('app.api.v1.endpoints.emails.get_async_db')
    def test_send_email_failure(self, mock_get_db, mock_email_service, mock_get_user):
    ...
    @patch('app.api.v1.endpoints.emails.EmailService')
    @patch('app.api.v1.endpoints.emails.get_async_db')
    def test_send_interview_email_success(self, mock_get_db, mock_email_service, mock_get_user):
    ...
    @patch('app.api.v1.endpoints.emails.EmailService')
    @patch('app.api.v1.endpoints.emails.get_async_db')
    def test_send_interview_email_invalid_date(self, mock_get_db, mock_email_service, mock_get_user):
    ...
    @patch('app.api.v1.endpoints.emails.EmailService')
    @patch('app.api.v1.endpoints.emails.get_async_db')
    def test_send_interview_email_invalid_time(self, mock_get_db, mock_email_service, mock_get_user):
    ...
    @patch('app.api.v1.endpoints.emails.EmailService')
    @patch('app.api.v1.endpoints.emails.get_async_db')
    def test_get_email_logs_success(self, mock_get_db, mock_email_service, mock_get_user):
    ...
    @patch('app.api.v1.endpoints.emails.EmailService')
    @patch('app.api.v1.endpoints.emails.get_async_db')
    def test_get_email_logs_with_filters(self, mock_get_db, mock_email_service, mock_get_user):
